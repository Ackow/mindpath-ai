...
阶段 1 的章节级知识点、练习、项目交付和验收标准见[《阶段1机器学习通识与问题定义详细规划》](./阶段1机器学习通识与问题定义详细规划.md)。建议用 4 周完成，并在进入监督学习前提交一份可复现的问题定义包。
...
阶段 2-6 的章节任务、项目与验收标准见[《阶段2-6详细学习规划》](./阶段2-6详细学习规划.md)。阶段 6 仅选择一个专项主线完成作品项目。
...
详细任务见[《阶段2-6详细学习规划》](./阶段2-6详细学习规划.md)。
...
详细任务与专项选择规则见[《阶段2-6详细学习规划》](./阶段2-6详细学习规划.md)。

### 6E AI Agent 与应用工程（建议专项）

- LLM API、提示工程、结构化输出、异步 Python、配置与密钥管理。
- LangChain 的链路与检索组件；RAG 的文档处理、检索、引用、评估与缓存。
- 工具调用、状态工作流、LangGraph、MCP、人工确认、预算和权限边界。
- FastAPI、认证授权、流式响应、测试、日志、追踪、评估、提示注入防护与部署。

专项的周粒度知识点、项目任务、验收和公开资料见[《AI Agent学习路线详细规划》](./AI Agent学习路线详细规划.md)。建议在完成阶段 5 后选择本专项，并以带引用、可评估、可审计的知识库助手作为项目。
