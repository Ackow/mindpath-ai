...
恭喜你完成了机器学习通识模块的学习！你已经掌握了 AI 的宏观全景与极简五步法。

接下来，我们将正式进入算法实战第一站 **[01. 线性回归与正则化](/learn/supervised-learning/01-linear-regression)**，深入学习如何用数学公式与 Python 手写出你第一个真正的回归模型！
